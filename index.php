    ...
    <div class="container">
        ...
        <?php
                if(!isset($_SESSION['username'])){
                    ...
                    echo "<a href='./user_area/profile.php'class='nav-link text-uppercase text-dark px-1'>Welcome ".$_SESSION['username']."
                        </a>";
                }
            if(!isset($_SESSION['username'])){
...
?>
<!-- header -->
<header id="header" class="vh-100 carousel slide" data-bs-ride="carousel" style="padding-top: 152px;">
    <div class="container h-100 d-flex align-items-center carousel-inner">
        <div class="text-center carousel-item active">
            <h2 class="text-capitalize text-white">best collection</h2>
            <h1 class="text-uppercase py-2 fw-bold text-white">Best Homemade</h1>
            <a href="#" class="btn mt-3 text-uppercase">shop now</a>
        </div>
        <div class="text-center carousel-item">
            <h2 class="text-capitalize text-white">best price & offer</h2>
            <h1 class="text-uppercase py-2 fw-bold text-white">new season</h1>
            <h1 class="text-uppercase py-2 fw-bold text-white">Nourish your body, feed your soul</h1>
            <a href="cart.php" class="btn mt-3 text-uppercase">buy now</a>
        </div>
    </div>
        ...
        <div class="row gy-lg-5 align-items-center">
            <div class="col-lg-6 order-lg-1 text-center text-lg-start">
                ...
                <p class="lead text-muted">Welcome to Dry Fruit Kingdom, a family-owned and operated dry fruit business based in Gilgit Baltistan, Pakistan. We are passionate about bringing the highest quality, locally-sourced dry fruits to our customers.
                    ...
                    Our story began over 1999 ago when our founders started growing and selling dry fruits from their own orchards. Over time, we have expanded our business to include a wider variety of dry fruits and nuts, while always maintaining a commitment to quality and sustainability.
